...
const recentCases = [
  ...
  {
    name: "Nhồi máu não bán cầu phải",
    modality: "CT",
    date: "04/04/2026",
    score: 75,
    weakStep: "DDx",
...
export function Performance() {
  ...
  return (
    ...
    >
      ...
      <div>
        <div
          className="px-4 md:px-8 py-5 max-w-7xl mx-auto"
        ...
        <div className="flex flex-col lg:flex-row gap-5 md:gap-6">
          ...
          >
            ...
            <div style={{ borderTop: "1px solid var(--border-dim)", paddingTop: 16 }}>
              ...
              {[
                "Dùng cả bằng chứng hình ảnh và lâm sàng",
