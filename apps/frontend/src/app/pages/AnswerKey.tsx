        ...
        <div className="flex-1 overflow-y-auto px-8 py-6 pb-24">
          ...
          <div className="mb-8 flex justify-center">
            ...
            >
              ...
              >
                {isUploadView
                  ? <>4 diagnostic steps: <span style={{ color: '#1B3A5C' }}>DESCRIBE</span> → <span style={{ color: '#C9882A' }}>REASONING</span> → <span style={{ color: '#5C3D2E' }}>DDx</span> → <span style={{ color: '#7D9B76' }}>CONCLUSION</span>. Click each step to unlock the next.</>
